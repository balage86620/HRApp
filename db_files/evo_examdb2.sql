DROP SCHEMA IF EXISTS `evo_examdb` ;
CREATE SCHEMA `evo_examdb` DEFAULT CHARACTER SET utf8 ;
USE `evo_examdb` ;

-- -----------------------------------------------------
-- Table `evo_examdb`.`hiring`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`hiring` ;
CREATE TABLE `evo_examdb`.`hiring` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`person` ;
CREATE TABLE `evo_examdb`.`person` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`application` ;
CREATE TABLE `evo_examdb`.`application` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Table `evo_examdb`.`cv`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`cv` ;
CREATE TABLE `evo_examdb`.`cv` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`degree` ;
CREATE TABLE `evo_examdb`.`degree` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`degree2person` ;
CREATE TABLE `evo_examdb`.`degree2person` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`skill` ;
CREATE TABLE `evo_examdb`.`skill` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`skill2person` ;
CREATE TABLE `evo_examdb`.`skill2person` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`interview` ;
CREATE TABLE `evo_examdb`.`interview` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`skill2hiring` ;
CREATE TABLE `evo_examdb`.`skill2hiring` (
  `hiring_id` INT(11) NOT NULL,
  `skill_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `evo_examdb`.`degree2hiring` ;
CREATE TABLE `evo_examdb`.`degree2hiring` (
  `hiring_id` INT(11) NOT NULL,
  `degree_id` INT(11) NOT NULL,
  `id` INT NOT NULL AUTO_INCREMENT,
